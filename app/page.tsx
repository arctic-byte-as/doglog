    ...
    <SiteShell>
      <div className="grid gap-8 lg:grid-cols-[1.5fr_1fr]">
        <div className="space-y-6">
          <div className="rounded-[2rem] bg-slate-900 px-8 py-12 text-white shadow-soft shadow-slate-900/10">
            <p className="text-sm uppercase tracking-[0.3em] text-slate-400">MVP prototype</p>
          ...
          <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-soft">
            <h2 className="text-2xl font-semibold text-slate-900">Why this prototype?</h2>
        ...
        <div className="space-y-6">
          {cards.map((card) => (
            <Link
              key={card.href}
              href={card.href}
              className="block rounded-3xl border border-slate-200 bg-white p-6 text-slate-900 transition hover:-translate-y-0.5 hover:shadow-soft"
            >
