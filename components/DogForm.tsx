    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <label className="block md:col-span-2">
          ...
          <input type="text" value={form.profileImageUrl} onChange={(event) => update('profileImageUrl', event.target.value)} placeholder="https://example.com/dog-photo.jpg or /uploads/dogs/photo.jpg" className="mt-1 w-full rounded-lg border border-brand-200 px-3 py-2" />
        </label>
      </div>
